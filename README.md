...
- Изучил гайдлайн по оптимизации reactjs [https://ru.reactjs.org/docs/optimizing-performance.html#virtualize-long-lists](https://ru.reactjs.org/docs/optimizing-performance.html#virtualize-long-lists) и пошел фигачить супер оптимизированный чат. В процессе:
  ...
  1. Рендер списка в обратном порядке.
  2. Рендер сообщений разной высоты
  3. Автоскроллинг листа, когда он обернут в HOC инфинит лоадера: InfiniteLoader.
  4. ...
     Before PROFIT: нашел Брайана Вона косяк нашел в issue на гитхабе https://github.com/bvaughn/react-window/issues/324#issuecomment-664483174
     ...
